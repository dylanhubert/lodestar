...
Lance `~/dev/dev-standards/scripts/scan-ia.sh`. Présente un rapport classé par nature :
...
- réécris en voix humaine (`~/dev/dev-standards/docs/voix.md`) les commentaires et docs qui sonnent IA, sans changer le comportement du code.
