...
4. Rédige ou complète `CHANGELOG.md` au format Keep a Changelog : une section par version, groupée par type (Ajouts, Corrections, Changements…), en **voix humaine** (`~/dev/claude-setup/docs/voix.md`), pas en jargon de commit brut.
...
Conventions : `~/dev/claude-setup/docs/git.md`. Ne réécris jamais l'historique.
